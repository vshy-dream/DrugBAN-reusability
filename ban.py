...
class BANLayer(nn.Module):
    def __init__(self, v_dim, q_dim, h_dim, h_out, act='ReLU', dropout=0.2, k=3):
        ...
        if 1 < k:
            ...
            # self.p_net = nn.MaxPool1d(self.k, stride=self.k) # max-pooling
    ...
    def attention_pooling(self, v, q, att_map):
        ...
        if 1 < self.k:
            ...
            # fusion_logits, _ = self.p_net(fusion_logits).max(dim=1) # max-pooling
...
class BCNet(nn.Module):
    ...
    def forward_with_weights(self, v, q, w):
        ...
        if 1 < self.k:
            ...
            # logits, _ = self.p_net(logits).max(dim=1) # max-pooling
        return logits
