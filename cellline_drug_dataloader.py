...
class DTIDataset(data.Dataset):
    ...
    # Extract drug, cell line features and drug-cell line interaction labels from datasets
    def __getitem__(self, index):
        ...
        v_p = self.df.iloc[index][1:-2]  
        v_p = v_p.values
        # Extract drug-cell line interaction labels
